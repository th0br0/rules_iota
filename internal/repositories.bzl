...
def load_glog():
    native.new_http_archive(
		    ...
		    url="https://github.com/google/glog/archive/5c292672df04ab82a97be5116d47dc0cc544b39f.zip",
		    strip_prefix="glog-5c292672df04ab82a97be5116d47dc0cc544b39f",
...
def load_keccak():
    native.new_http_archive(
        ...
        strip_prefix="XKCP-c737139c81fd191699886a9a74d3220f6e300b29",
...
def load_sqlite3():
    native.new_http_archive(
        ...
        sha256=
        "8dba212aeb7c25352a74d70141f20ba421bf20af8b2fb661f2b0dce473aba487",
...
def load_uthash():
    native.new_http_archive(
        ...
        url=
        "https://github.com/troydhanson/uthash/archive/91fcf37aea9f79535d281ae366996c9f409a1701.zip",
...
def load_http_parser():
    native.new_http_archive(
        ...
        sha256=
        "8d734182456143fc94ab95dcea01b84c13d83b2c9345930445da7eb83ebe4090",
...
def load_libunwind():
    native.new_http_archive(
        name="libunwind",
        url=
        "http://download.savannah.nongnu.org/releases/libunwind/libunwind-1.2.1.tar.gz",
        strip_prefix="libunwind-1.2.1/",
        sha256=
        "3f3ecb90e28cbe53fba7a4a27ccce7aad188d3210bb1964a923a731a27a75acb",
        build_file="@rules_iota//:build/BUILD.libunwind", )
